...
# see https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/compute_instance#name
variable "compute_instance_name" {
  type        = string
  description = "Resource name."

  # NOTE: Setting defaults in Modules may be an anti-pattern.
  default = "vdnkh"
}

# see https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/dns_zone#name
...
# see https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/dns_zone#zone
variable "dns_zone_zone" {
  type        = string
